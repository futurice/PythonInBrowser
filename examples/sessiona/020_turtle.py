...
taylor.shape("turtle")  # kilpparilla voi olla monia muotoja
...
## ja liikkumaan taas suoraan 100 pikseliä.
...
## Tehtäväsi on saada kilppari piirtämään vähintään 5 viivaa.
## Vinkki: Käytä ylläolevia komentoja luovasti.
