...
# Note that you should use the measures
# given in the definition of hexahedron.
#

# Function to draw frontside, fill this
def frontside(w, h):
  print "This function should draw the front side of function"

# Function to draw topside, fill this
def topside(w, d):
  print "This function should draw the top side of function"

# Function to draw rightside, fill this
def rightside(h, d):
  print "This function should draw the right side of function"
